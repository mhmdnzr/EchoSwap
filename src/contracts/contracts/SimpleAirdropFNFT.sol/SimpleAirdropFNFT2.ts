...
export interface SimpleAirdropFNFT2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "amountPerUser"
      | "distributeAirdrop"
  ...
  decodeFunctionResult(functionFragment: "pushFNFT", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "secondOwner",
    data: BytesLike
  ): Result;
...
export interface SimpleAirdropFNFT2 extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleAirdropFNFT2;
  waitForDeployment(): Promise<this>;

  interface: SimpleAirdropFNFT2Interface;
  ...
  pushFNFT: TypedContractMethod<[_users: AddressLike[]], [void], "nonpayable">;
