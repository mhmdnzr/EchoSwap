...
export interface AirdropClaimTheNFTTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "LOCK_PERIOD"
      | "PRECISION"
...
export interface AirdropClaimTheNFTTest extends BaseContract {
  connect(runner?: ContractRunner | null): AirdropClaimTheNFTTest;
  waitForDeployment(): Promise<this>;

  interface: AirdropClaimTheNFTTestInterface;
