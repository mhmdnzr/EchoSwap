...
export interface AirdropClaimTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DISTRIBUTION_PERIOD"
      | "INIT_SHARE"
...
export interface AirdropClaimTest extends BaseContract {
  connect(runner?: ContractRunner | null): AirdropClaimTest;
  waitForDeployment(): Promise<this>;

  interface: AirdropClaimTestInterface;
