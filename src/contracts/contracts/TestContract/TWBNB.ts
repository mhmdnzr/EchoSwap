...
export interface TWBNBInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface TWBNB extends BaseContract {
  connect(runner?: ContractRunner | null): TWBNB;
  waitForDeployment(): Promise<this>;

  interface: TWBNBInterface;
