...
export interface MerkleTreeTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_init"
      | "airdropClaim"
...
export interface MerkleTreeTest extends BaseContract {
  connect(runner?: ContractRunner | null): MerkleTreeTest;
