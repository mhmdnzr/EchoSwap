...
export interface MerkleTreeTHENFTTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_init"
      | "airdropClaim"
  ...
  encodeFunctionData(functionFragment: "info2", values?: undefined): string;
  ...
  encodeFunctionData(
    functionFragment: "setairdropClaim",
    values: [AddressLike]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "info2", data: BytesLike): Result;
...
export interface MerkleTreeTHENFTTest extends BaseContract {
  connect(runner?: ContractRunner | null): MerkleTreeTHENFTTest;
  waitForDeployment(): Promise<this>;

  interface: MerkleTreeTHENFTTestInterface;
  ...
  info2: TypedContractMethod<[], [string], "view">;
  ...
  setairdropClaim: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "setairdropClaim"
  ): TypedContractMethod<[_airdropclaim: AddressLike], [void], "nonpayable">;
