...
export interface L2GovernorVotesQuorumFractionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "COUNTING_MODE"
...
export interface L2GovernorVotesQuorumFraction extends BaseContract {
  connect(runner?: ContractRunner | null): L2GovernorVotesQuorumFraction;
  waitForDeployment(): Promise<this>;

  interface: L2GovernorVotesQuorumFractionInterface;
