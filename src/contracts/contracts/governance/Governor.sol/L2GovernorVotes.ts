...
export interface L2GovernorVotesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "COUNTING_MODE"
...
export interface L2GovernorVotes extends BaseContract {
  connect(runner?: ContractRunner | null): L2GovernorVotes;
  waitForDeployment(): Promise<this>;

  interface: L2GovernorVotesInterface;
