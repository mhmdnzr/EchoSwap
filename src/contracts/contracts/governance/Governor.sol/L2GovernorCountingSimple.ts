...
export interface L2GovernorCountingSimpleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "COUNTING_MODE"
...
export interface L2GovernorCountingSimple extends BaseContract {
  connect(runner?: ContractRunner | null): L2GovernorCountingSimple;
  waitForDeployment(): Promise<this>;

  interface: L2GovernorCountingSimpleInterface;
