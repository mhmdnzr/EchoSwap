...
export interface L2GovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "COUNTING_MODE"
...
export interface L2Governor extends BaseContract {
  connect(runner?: ContractRunner | null): L2Governor;
  waitForDeployment(): Promise<this>;

  interface: L2GovernorInterface;
