...
export interface VoterV2_1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "_initialize"
      | "_ve"
  ...
  encodeFunctionData(
    functionFragment: "killGaugeTotally",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface VoterV2_1 extends BaseContract {
  connect(runner?: ContractRunner | null): VoterV2_1;
  waitForDeployment(): Promise<this>;

  interface: VoterV2_1Interface;
  ...
  increaseGaugeApprovals: TypedContractMethod<
    [_gauge: AddressLike],
    [void],
    "nonpayable"
  >;

  initGauges: TypedContractMethod<
    [_gauges: AddressLike[], _pools: AddressLike[]],
    [void],
    "nonpayable"
  >;
  ...
  killGaugeTotally: TypedContractMethod<
    [_gauge: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  setNewBribe: TypedContractMethod<
    [_gauge: AddressLike, _internal: AddressLike, _external: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  "whitelist(address)": TypedContractMethod<
    [_token: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "increaseGaugeApprovals"
  ): TypedContractMethod<[_gauge: AddressLike], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "initGauges"
  ): TypedContractMethod<
    [_gauges: AddressLike[], _pools: AddressLike[]],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "killGaugeTotally"
  ): TypedContractMethod<[_gauge: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "whitelist(address)"
